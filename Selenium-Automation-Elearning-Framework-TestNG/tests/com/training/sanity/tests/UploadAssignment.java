...
public class UploadAssignment {
	...
	public void uploadAssignment() throws InterruptedException {
		//go to course detail tab and verify if the registered course is displayed
		courseDetailsPOM.clickMyCourseLink();
		Thread.sleep(1000);
		courseDetailsPOM.clickCourseItem();
		Thread.sleep(2000);
		
		courseDetailsPOM.clickCourseAssignment();
		Thread.sleep(2000);
		
		courseDetailsPOM.clickAssignmentLink();
		Thread.sleep(2000);
		
		courseDetailsPOM.clickUploadAssignmentImage();
		Thread.sleep(2000);
		
		courseDetailsPOM.clickUploadSimpleTab();
		Thread.sleep(2000);
		
		courseDetailsPOM.sendFileChooseFileBtn();
		Thread.sleep(2000);
		
		courseDetailsPOM.clickUploadBtn();
		Thread.sleep(2000);
		
		courseDetailsPOM.verifyAssignmentNameExist();
		Thread.sleep(2000);
